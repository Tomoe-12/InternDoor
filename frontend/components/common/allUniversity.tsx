...
const universities = [
  {
    ...
    description:
      "A world-renowned research university known for its programs in physical sciences and engineering.",
  },
  {
    id: "stanford",
    ...
    description:
      "One of the world's leading teaching and research institutions, located in Silicon Valley.",
  },
  {
    id: "harvard",
  ...
  },
  {
    ...
    description:
      "A premier public research university known for its academic excellence and social activism.",
  },
];
const AllUniversity = () => {
