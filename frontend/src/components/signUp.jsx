...
import img from '../assets/images/HomeImg/signUp.svg'
            ...
            <section className="bg-white ">
                <div className="flex justify-center min-h-screen">
                    ...
                    <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5 ">
                        {/* close button  */}
                        <button className="btn btn-circle btn-outline absolute top-10 right-24" onClick={(e)=>{e.preventDefault(); navigate('/')}}>
                            ...
                            <div className="mt-6">
                                ...
                                <div className="mt-3 md:flex md:items-center md:-mx-2">
                                    <button className="flex justify-center items-center w-full px-6 py-3 text-white bg-blue-500 rounded-lg md:w-auto md:mx-2 focus:outline-none">
                                        ...
                                        <img src={student} className='w-7 h-7 icon-black' alt="" />
                                        <span className="mx-2">
                                            Student
                                        </span>
                                    </button>
                                    <button className="flex justify-center items-center w-full px-6 py-3 mt-4 text-blue-500 border border-blue-500 rounded-lg md:mt-0 md:w-auto md:mx-2   focus:outline-none">
                                        {/* <svg xmlns="http://www.w3.org/2000/svg" className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                            <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                        </svg> */}
                                        <img src={company} className='w-7 h-7 ' alt="" style={{ fill: 'red' }} />
                                        <span className="mx-2">
                                            Company
                                        </span>
                                    </button>
