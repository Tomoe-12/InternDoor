...
const Profile = () => {
    ...
    return (
        <>
            <section className="py-10 md:pt-32 pt-20 ">
                <div className="lg:w-[70%] md:w-[90%] xs:w-[96%] mx-auto flex gap-4">
                    <div className="lg:w-[88%] md:w-[80%] sm:w-[88%] xs:w-full mx-auto shadow-3xl px-10 py-7 rounded-xl h-fit self-center ">
                        {/* Profile Form */}
                        <div>
                            <h1 className="text-blue-500 tracking-wider lg:text-4xl md:text-3xl sm:text-2xl xs:text-2xl font-serif font-extrabold mb-2 ">
                                Profile
                            </h1>
                            ...
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="mt-10 flex justify-center">
                                    <div className=" w-fit h-fit relative md:bottom-5 bottom-16  ">
                                        {
                                            user?.photoURL
                                        ...
                                        <div className="top-0 right-4 flex items-center justify-center  absolute bg-white border border-gray-300 rounded-full  w-10 h-10 text-center ">
                                ...
                                <div className="grid gap-6 mt-8 md:grid-cols-2 grid-cols-1 ">
                                    {/* name */}
                                    <div className="col-span-2 sm:col-span-1 " >
                                        <label className="block mb-2 text-sm text-gray-600 ">Name</label>
                                        <input {...register('name')} type="text" placeholder={user?.name || 'mg mg'} className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg     focus:border-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                    </div>

                                    <div className="col-span-2 sm:col-span-1 " >
                                        <label className="block mb-2 text-sm text-gray-600 ">Roll NO</label>
                                        <input {...register('rollno')} type="text" placeholder={user?.rollno || '5CS-5'} className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg     focus:border-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                    </div>
                                    <div className="col-span-2 sm:col-span-1" >
                                        <label className="block mb-2 text-sm text-gray-600 ">Phone number</label>
                                        <input {...register('phone')} type="tel" maxLength={12} placeholder={user?.phone || '09 233 211 234'} className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg     focus:border-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                    </div>

                                    <div className="col-span-2 sm:col-span-1" >
                                        <label className="block mb-2 text-sm text-gray-600 ">Email address</label>
                                        <input {...register('email')} type="email" placeholder={user?.email || "johnsnow@ucstgi.com"} className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg     focus:border-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                    </div>
                                    <div className='col-span-2'>
                                        <label className="block mb-2 text-sm text-gray-600 ">Address</label>
                                        <input {...register('address')} type="text" placeholder={user?.address || "Address"} className="block w-full px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg     focus:border-blue-400  focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                                    </div>
