...
export default function UniversityStudentProfilePage({
  params,
}: {
  ...
  return <StudentDetails student={student!} id={studentId} />;
}
...
const students = [
  {
    ...
    interests:
      "Software development and AI applications in healthcare technology",
