...
import { ArrowLeft, School, MapPin, Users, Globe, Mail, Phone, ExternalLink, Plus, X } from "lucide-react"
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-[600px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Update all information for the university profile. Click save when you're done.
                    </DialogDescription>
                  </DialogHeader>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input id="email" type="email" defaultValue={uni.email} />
                    </div>
                    <div className="grid gap-2">
                    ...
                    <div className="grid gap-2">
                      ...
                      <Input id="studentsCount" type="number" defaultValue={uni.studentsCount} />
                    </div>
                    <div className="grid gap-2 md:col-span-2">
                      <Label htmlFor="description">Description</Label>
                      <Textarea id="description" defaultValue={uni.description} className="h-24" />
                    </div>
                  </div>
                  <DialogFooter>
              ...
              <Dialog>
                ...
                <DialogContent className="sm:max-w-[525px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Manage staff members who have administrative access to this institution.
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  {uni.enrolledStudents.map((student) => (
                    <TableRow key={student.id}>
                      ...
                      <TableCell className="text-right pr-6">
                        <Button variant="ghost" size="sm" asChild>
                          <Link href={`${id}/students/${student.id}`}>View</Link>
                        </Button>
                      </TableCell>
                    </TableRow>
                  ))}
